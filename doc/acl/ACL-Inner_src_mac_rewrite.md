...
|:---:|:-----------:|:------------------:|-----------------------------------|
| 0.1 | 04/07/2025  |    Anish Narsian   | Initial version                   |

# About this Manual
This document provides the high level design for performing Src MAC rewrite on the inner headers of a VXLAN encapsulated packet for those packets which match a given src IP and VNI. 
Associated SAI proposal: https://github.com/opencomputeproject/SAI/pull/2079/files

# Scope
This document provides the high level application layer design for performing Src MAC rewrite on the inner headers of a VXLAN encapsulated packet by reusing the existing ACL infrastruture in SONiC and SWSS. 
